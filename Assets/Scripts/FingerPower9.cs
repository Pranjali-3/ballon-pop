...
public class FingerPower9 : MonoBehaviour {
...
//			LevelManager.levelManager.ScorePoint(1);
	...
	void Update()
	{
		if ((Input.touchCount > 9 && Input.touches[9].phase == TouchPhase.Began) && !LevelManager.gamePaused && !LevelManager.gameOver && EventSystem.current.currentSelectedGameObject == null)
		{
			Click(Input.touches[9].position);
		}
