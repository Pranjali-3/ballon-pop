...
public class FingerPower2 : MonoBehaviour {
...
//			LevelManager.levelManager.ScorePoint(1);
	...
	void Update()
	{
		if ((Input.touchCount > 2 && Input.touches[2].phase == TouchPhase.Began) && !LevelManager.gamePaused && !LevelManager.gameOver && EventSystem.current.currentSelectedGameObject == null)
		{
			Click(Input.touches[2].position);
		}
