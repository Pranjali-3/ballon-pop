...
public class FingerPower8 : MonoBehaviour {
...
//			LevelManager.levelManager.ScorePoint(1);
	...
	void Update()
	{
		if ((Input.touchCount > 8 && Input.touches[8].phase == TouchPhase.Began) && !LevelManager.gamePaused && !LevelManager.gameOver && EventSystem.current.currentSelectedGameObject == null)
		{
			Click(Input.touches[8].position);
		}
