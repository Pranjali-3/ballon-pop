...
public class FingerPower6 : MonoBehaviour {
...
//			LevelManager.levelManager.ScorePoint(1);
	...
	void Update()
	{
		if ((Input.touchCount > 6 && Input.touches[6].phase == TouchPhase.Began) && !LevelManager.gamePaused && !LevelManager.gameOver && EventSystem.current.currentSelectedGameObject == null)
		{
			Click(Input.touches[6].position);
		}
