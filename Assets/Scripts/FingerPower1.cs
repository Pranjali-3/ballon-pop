...
public class FingerPower1 : MonoBehaviour {
...
//			LevelManager.levelManager.ScorePoint(1);
	...
	void Update()
	{
		if ((Input.touchCount > 1 && Input.touches[1].phase == TouchPhase.Began) && !LevelManager.gamePaused && !LevelManager.gameOver && EventSystem.current.currentSelectedGameObject == null)
		{
			Click(Input.touches[1].position);
		}
